...
const PROMOS: Promo[] = [
  ...
  {
    title: "Hoàn 1.2% thể thao",
    desc: "Theo doanh thu ròng.",
    label: "Hoàn 1.2%",
  },
    ...
    <section id="uu-dai" className="py-8">
      ...
      <div className="mt-4 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        {PROMOS.map((p) => (
          <article
            key={p.title}
            className="min-h-[12rem] bg-white rounded-xl border border-slate-200 shadow-card p-4 grid content-between"
          >
            ...
            <div>
              ...
              <Button className="mt-1" size="sm" variant="brand">
                Tìm hiểu
              </Button>
            </div>
          </article>
